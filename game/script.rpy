...
label morning_tea_1:
    ...
    p "Hello."
    pl "Hey everyone."
    l "Guys, I was talking to [name] about this really cool spot I found that we can go to after school."
    nar "Everyone looks at Lucien, but Paul just stares at the ground."
    n "Lucien continues to tell the group what he told you earlier about the springs."
    l "So, who can come?"
    a "Sure"
    l "What about you Jauqes?"
    j "Hmmm"
    j "Why not, I'll come"
    l "Oh well! That's everyone. Whos Exite-"
    p "What about me?"
    l "Sorry Paul. Can you come?"
    p "Yeah Sure. If you want me too."
    l "Fine"
    j "Fine"
    a "Fine"
