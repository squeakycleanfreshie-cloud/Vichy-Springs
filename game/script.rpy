        ...
        menu:
            ...
            "Look for him":
                ...
                if paul >= 2 and jaques >= 2 and arthur >= 2:
                    ...
                    nar "They leave, leaving you and Lucien alone."
                    pl "Are we going to talk?"
                    l "Yes."
                    l "Why would you treat me like that?"
                    pl "I'm sorry."
                    pl "I over-reacted."
                    pl "I hope you can forgive me."
                    nar "Lucien stays silent, thinking."
                    l "Fine."
                    pl "Yay!"
                    pl "Are you still coming to the springs?" 
                    l "Sure. It was my idea though."
                    pl "Yeah, I was just asking."
                    $ achievement.grant("popular")
                elif paul >= 2 and jaques >= 2:
                    p "I'll come!"
                    j "I come along too"
                    nar "You, Paul, and Jaques walk through the corridors of the school."
                    pl "I forgot to ask, where could we even find him?"
                    nar "Paul and Jaques look at each other, grinning."
                    p "Mr Gaspards room."
                    pl "Who is that?"
                    j "For some reason, Lucien loves this teacher."
                    p "He's good."
                    j "But he's not special or anything."
                    p "Lucien is definitely his favourite student."
                    j "Like sometimes he spends after school with Lucien"
                    pl "Doing what?"
                    p "We don't know. He doesn't invite anyone."
                    pl "Have you asked to go with him."
                    j "No. Not really."
                    p "And we arrive!"
                    nar "You and the boys walk inside his room. Mr Gaspard is sitting at his desk, doing work."
                    nar "Also sitting at the back of the classroom is Lucien."
                    pl "Lucien are you okay?"
                    l "Not how you treated me this morning!"
                    p "I don't think we are part of this..."
                    s "Is everything alright boys?"
                    j "Yes. We think.."
                    s "Ok. I'm out of here to get lunch."
                    nar "Mr Gaspard leaves the room, and shuts the door."
                    j "I think we are going to leave too..."
                    p "And let you guys sort this out."
                    nar "They leave, leaving you and Lucien alone."
                    pl "Are we going to talk?"
                    l "Yes."
                    l "Why would you treat me like that?"
                    ...
                    p "I'll come!"
                    a "Sure."
                    nar "You, Paul, and Arthur walk through the corridors of the school."
                    pl "I forgot to ask, where could we even find him?"
                    nar "Paul and Arthur look at each other, grinning."
                    a "Mr Gaspards room."
                    pl "Who is that?"
                    a "For some reason, Lucien loves this teacher."
                    p "He's good."
                    a "But he's not special or anything."
                    p "Lucien is definitely his favourite student."
                    a "Like sometimes he spends after school with Lucien"
                    pl "Doing what?"
                    a "We don't know. He doesn't invite anyone."
                    pl "Have you asked to go with him."
                    p "No. Not really."
                    ...
                    s "Ok. I'm out of here to get lunch."
                    nar "Mr Gaspard leaves the room, and shuts the door."
                    a "I think we are going to leave too..."
                    p "And let you guys sort this out."
                    nar "They leave, leaving you and Lucien alone."
                    pl "Are we going to talk?"
                    l "Yes."
                    ...
                    j "Sure"
                    a "Don't forget me."
                    nar "You, Jaques, and Arthur walk through the corridors of the school."
                    pl "I forgot to ask, where could we even find him?"
                    nar "Jaques and Arthur look at each other, grinning."
                    a "Mr Gaspards room."
                    pl "Who is that?"
                    a "For some reason, Lucien loves this teacher."
                    j "He's good."
                    a "But he's not special or anything."
                    j "Lucien is definitely his favourite student."
                    a "Like sometimes he spends after school with Lucien"
                    pl "Doing what?"
                    a "We don't know. He doesn't invite anyone."
                    pl "Have you asked to go with him."
                    ...
                    pl "Lucien are you okay?"
                    l "Not how you treated me this morning!"
                    j "I don't think we are part of this..."
                    s "Is everything alright boys?"
                    a "Yes. We think.."
                    s "Ok. I'm out of here to get lunch."
                    nar "Mr Gaspard leaves the room, and shuts the door."
                    a "I think we are going to leave too..."
                    j "And let you guys sort this out."
                    nar "They leave, leaving you and Lucien alone."
                    pl "Are we going to talk?"
                    l "Yes."
                    l "Why would you treat me like that?"
                    ...
                    p "I'll come!"
                    nar "You and Paul walk through the corridors of the school."
                    pl "I forgot to ask, where could we even find him?"
                    p "Mr Gaspards room, probably."
                    pl "Who is that?"
                    p "For some reason, Lucien loves this teacher."
                    p "He's good, but not special or anything."
                    p "Lucien is definitely his favourite student. Sometimes he spends after school with him."
                    pl "Doing what?"
                    p "I don't know. He doesn't invite anyone."
                    pl "Have you asked to go with him."
                    p "No. Not really."
                    p "And we arrive!"
                    nar "You and Paul walk inside his room. Mr Gaspard is sitting at his desk, doing work."
                    nar "Also sitting at the back of the classroom is Lucien."
                    pl "Lucien are you okay?"
                    l "Not how you treated me this morning!"
                    p "I don't think I'm part of this..."
                    s "Is everything alright boys?"
                    p "Yes. We think.."
                    s "Ok. I'm out of here to get lunch."
                    nar "Mr Gaspard leaves the room, and shuts the door."
                    p "I think I'm going to leave too, and let you guys sort this out."
                    nar "He leaves, leaving you and Lucien alone."
                    pl "Are we going to talk?"
                    l "Yes."
                    l "Why would you treat me like that?"
                    pl "I'm sorry."
                    ...
                    j "I'll come!"
                    nar "You and Jaques walk through the corridors of the school."
                    pl "I forgot to ask, where could we even find him?"
                    j "Mr Gaspards room, probably."
                    pl "Who is that?"
                    j "For some reason, Lucien loves this teacher."
                    j "He's good, but not special or anything."
                    j "Lucien is definitely his favourite student. Sometimes he spends after school with him."
                    pl "Doing what?"
                    j "I don't know. He doesn't invite anyone."
                    pl "Have you asked to go with him."
                    j "No. Not really."
                    j "And we arrive!"
                    nar "You and Jaques walk inside his room. Mr Gaspard is sitting at his desk, doing work."
                    nar "Also sitting at the back of the classroom is Lucien."
                    pl "Lucien are you okay?"
                    l "Not how you treated me this morning!"
                    j "I don't think I'm part of this..."
                    s "Is everything alright boys?"
                    j "Yes. We think.."
                    s "Ok. I'm out of here to get lunch."
                    nar "Mr Gaspard leaves the room, and shuts the door."
                    j "I think I'm going to leave too, and let you guys sort this out."
                    nar "He leaves, leaving you and Lucien alone."
                    pl "Are we going to talk?"
                    l "Yes."
                    l "Why would you treat me like that?"
                    ...
                    nar "You and Arthur walk through the corridors of the school."
                    pl "I forgot to ask, where could we even find him?"
                    a "Mr Gaspards room, probably."
                    pl "Who is that?"
                    a "For some reason, Lucien loves this teacher."
                    a "He's good, but not special or anything."
                    a "Lucien is definitely his favourite student. Sometimes he spends after school with him."
                    pl "Doing what?"
                    a "I don't know. He doesn't invite anyone."
                    pl "Have you asked to go with him."
                    a "No. Not really."
                    a "And we arrive!"
                    nar "You and Arthur walk inside his room. Mr Gaspard is sitting at his desk, doing work."
                    nar "Also sitting at the back of the classroom is Lucien."
                    pl "Lucien are you okay?"
                    l "Not how you treated me this morning!"
                    a "I don't think I'm part of this..."
                    s "Is everything alright boys?"
                    a "Yes. We think.."
                    s "Ok. I'm out of here to get lunch."
                    nar "Mr Gaspard leaves the room, and shuts the door."
                    a "I think I'm going to leave too, and let you guys sort this out."
                    nar "He leaves, leaving you and Lucien alone."
                    pl "Are we going to talk?"
                    l "Yes."
                    l "Why would you treat me like that?"
                    ...
                    nar "You get up and leave the group behind, wandering the school corridors on your own."
                    nar "You have no idea where to even start looking."
                    nar "You check the library. Empty."
                    nar "You check the quad. No sign of him."
                    pl "Great."
                    nar "The bell rings, echoing down the empty hallway."
                    pl "I guess I'll just see him at the springs."
                    nar "You walk back to class alone, the search having led nowhere."
...
label going_to_vichy_springs_2:
    nar "The rest of the day passes, and as soon as that final bell goes you run out of the door."
    nar "You meetup with the group."
    pl "Hey Guys! Ready for the springs?"
    nar "The group eagearly nods back."
    nar "So you make the trek towards the springs. You take the same walk as before."
    j "Guess what guys!"
    a "What?"
    j "I got like 94% on my test."
    l "No you didn't. Your avarage is like just passing."
    j "Glad for you to jump to conclusions!"
    p "Jauqes, did you cheat?"
    j "I would Never!"
    p "Then how did you do so well?"
    j "I actually studied!"
    a "Can I see the test?"
    ...
    j "Thats not true-"
    j "We would be home until we noticed!"
    nar "The group laughs"
    nar "Jaques jogs up to catch up with the group."
    l "We have arrived!"
    nar "You walk through the bushes and arrive at the beatiful, Vichy Springs"
    j "This sites arcitecture astounds me!"
    p "Your such a nerd!"
    j "I was just saying.."
    l "Ok, lets get changed."
    nar "Its awkward because nobody wants to get changed in front of eachother."
    pl "I'll go over here"
    nar "You walk back into the bush pathway and get changed into your swimmers"
    nar "Once you return, everyone is changed, and jumps into the water."
    j "So warm!"
    a "And nice.."
    nar "You notice the water is shining green"
    nar "Not in a way of sunlight, but un-natural light, like a pulsing glow."
    nar "Its coming from the bottom of the springs"
    pl "Whats that light?"
    a "Yeah that is odd?"
    l "Why don't we swim down to see? I'll race you!"
    a "Its pretty deep, probably like 10 meters."
    j "More of a challenge for me to win!"
    j "GO!"
    pl "Buh- You gave yourself a hea-"
    nar "Before you can finish all of the boys race down to the bottom, leaving you alone at the top."
    pl "I guess there is no point going..."
    nar "You wait for the boys to return back to the surface."
    nar "SPLASH! All of the water erupts out of the pool, and it continues to bubble."
    pl "What the-"
    nar "The bubbling continues violently. Nobody comes up from the pool."
    nar "Its been 30 seconds..."
    nar "You don't know weather to leave or stay in."
    nar "You decide to swim down to the bottom to find them."
    nar "You plug your nose with your hand, and plunge down. Your mouth is filled with water that you swallow."
    nar "You open your eyes, and they sting."
    nar "Nobody is there. The pool is empty."
    nar "You swim down even deeper to investigate. You are slowly running out of air."
    pl "What!"
